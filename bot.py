...
def welcome_new_member(message):
    for user in message.new_chat_members:
        caption = (
            ...
            အမြဲအသင့်ရှိပါတယ် 🤓\n\n"
            "✨📚 မင်းကြိုက်တဲ့စာအုပ်တွေ ရွေးဖတ်ဖို့ Button ကိုနှိပ်ပါ ✨"
        )
...
# ======================================================
# 2️⃣ LINK BLOCKER (GROUP ONLY) - FIXED
# ======================================================
def is_link(text):
...
def block_links(message):
    try:
        # Get user status in chat - FIXED VERSION
        ...
        # Delete message and warn for regular users
        bot.delete_message(message.chat.id, message.message_id)
        warning_msg = f"⚠️ {message.from_user.first_name} 💢 Link များကို ပိတ်ထားပါတယ် 🙅🏻\n\n ❗ လိုအပ်ချက်တစ်ခုခုအတွက် Owner ကို ဆက်သွယ်ပါနော်..."
...
**စာအုပ်ရှာရန် နှစ်ပိုင်းခွဲထားတယ် 
